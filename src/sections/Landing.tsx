    ...
    <div className="h-[150vh] bg-purple3">
      ...
      >
        ...
        <div
          ...
          style={{ transform: `translateX(-${progress * slowMoveSpeed}vw)` }}
        >
        ...
        <img
          ...
          -right-20 max-h-[60vh]"
          style={{ transform: `translateX(-${progress * fastMoveSpeed}vw)` }}
        />
        <img
          src={clouds}
          alt="clouds"
        ...
        <img
          ...
          style={{
            transform: `translateX(-${progress * (slowMoveSpeed + 5)}vw)`,
          }}
        />
        <img
          src={houses}
          ...
          style={{ transform: `translateX(-${progress * mediumMoveSpeed}vw)` }}
        />
        <img
          src={cinema}
          alt="cinema building"
